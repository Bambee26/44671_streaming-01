...
def convert_k_to_f(temp_k):
    ...
    # Convert the input temperature value to a float
    temp_k_float = float(temp_k)
    fahrenheit = round((temp_k_float - 273.15) * 9/5 + 32, 2)
    logging.debug(f"Converted {temp_k_float}K to {fahrenheit}F.")
    return fahrenheit
